...
class Memory(nn.Module):
  ...
  def forward(self, ξ, hidden):
    ...
    # print("write_key", write_key.shape)
    # print("write_vector", write_vector.shape)
    # print("erase_vector", erase_vector.shape)
    # print("free_gates", free_gates.shape)
    # print("read_keys", read_keys.shape)
    # print("read_strengths", read_strengths.shape)
    # print("write_strength", write_strength.shape)
    # print("write_gate", write_gate.shape)
    # print("allocation_gate", allocation_gate.shape)
    # print("read_modes", read_modes.shape)

# write_key torch.Size([100, 1, 10])
# write_vector torch.Size([100, 1, 10])
# erase_vector torch.Size([100, 1, 10])
# free_gates torch.Size([100, 1])
# read_keys torch.Size([100, 1, 10])
# read_strengths torch.Size([100, 1])
# write_strength torch.Size([100, 1])
# write_gate torch.Size([100, 1])
# allocation_gate torch.Size([100, 1])
# read_modes torch.Size([100, 1, 3])
